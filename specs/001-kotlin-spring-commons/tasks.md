...
- [x] T003 [FR-001] [SC-001] Add `dev.extratoast:kotlin-commons-messaging:0.4.0` to `README.md`.
...
- `./gradlew build`
- `GH_TOKEN=$TOKEN gh pr checks <number> -R ExtraToast/kotlin-spring-commons`
- `GH_TOKEN=$TOKEN gh run list -R ExtraToast/kotlin-spring-commons --workflow Publish`
