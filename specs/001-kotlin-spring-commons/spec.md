...
- [REQ-010] [FR-001] The messaging module MUST publish as `dev.extratoast:kotlin-commons-messaging`.
...
- [SC-001] A consumer can depend on `dev.extratoast:kotlin-commons-messaging` without taking unrelated commons modules except the event API required by the publisher contract.
