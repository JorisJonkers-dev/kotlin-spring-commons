...
/**
 * OPTIONAL-BY-MODE outbound port. REQUIRED for
 * [com.jorisjonkers.personalstack.common.sync.application.service.SpawnSyncService], paged backfills,
 * and `AuthorityMode.MULTI_WRITER`. The Spring default is an "unsupported" store that fails when a
 * spawn/backfill mode actually calls it, rather than silently dropping cursors.
 *
